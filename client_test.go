...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Research.New(context.Background(), caesar.ResearchNewParams{
		Query: "REPLACE_ME",
	})
	if userAgent != fmt.Sprintf("Caesar/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Research.New(context.Background(), caesar.ResearchNewParams{
		Query: "REPLACE_ME",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Research.New(cancelCtx, caesar.ResearchNewParams{
		Query: "REPLACE_ME",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Research.New(deadlineCtx, caesar.ResearchNewParams{
			Query: "REPLACE_ME",
		})
		if err == nil {
